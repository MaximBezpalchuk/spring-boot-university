...
public class FormatterTest {
	...
	public void printResultTest() {
		...
		Teacher teacher = new Teacher("Amigo", "Bueno", "999", "Puerto Rico", "dot@dot.com", "shemale", "123", "none", LocalDate.of(1999, 1, 1), cathedra);
		lectures.add(new Lecture(subject, date, time, audience, teacher));
		Formatter formatter = new Formatter();
		assertEquals("Date: 2020-01-01 | Subject: TestSubject        | Audience: 1 | Teacher: Amigo Bueno    ", formatter.format(lectures));
	}
}
