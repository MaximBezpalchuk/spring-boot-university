...
public class DataUpdater {
	...
	public Student createStudent(String firstName, String lastName, String phone, String address, String email,
		...
		Student student = Student.build(firstName, lastName, address, gender, birthDate).setPhone(phone).setEmail(email)
				.setPostalCode(postalCode).setEducation(education).build();
		return student;
	}
	...
	public Teacher createTeacher(String firstName, String lastName, String phone, String address, String email,
		...
		Teacher teacher = Teacher.build(firstName, lastName, address, gender, birthDate, cathedra, degree)
