...
public class DataUpdater {
	...
	public Student createStudent(String firstName, String lastName, String phone, String address, String email,
		...
		Student student = Student.builder().firstName(firstName).lastName(lastName).address(address).gender(gender)
				.birthDate(birthDate).phone(phone).email(email).postalCode(postalCode).education(education).build();
		return student;
	}
	...
	public Teacher createTeacher(String firstName, String lastName, String phone, String address, String email,
		...
		Teacher teacher = Teacher.builder().firstName(firstName).lastName(lastName).address(address).gender(gender)
				.birthDate(birthDate).cathedra(cathedra).degree(degree).phone(phone).email(email).postalCode(postalCode)
